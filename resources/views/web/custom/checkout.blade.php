...
<div class="col-md-12 col-sm-8 content">
	...
	<div class="col-md-12">
		...
		<h3>Transaction Pre Order Information</h3>
		<hr />
		<div class="box">
			<div class="box-head">
				<h3>Your Invoiced</h3>
			...
			<form method="post" action="{{ url('/customInvoice') }}">
				{{ csrf_field() }}
				...
				<thead>
					...
					<tr>
						<td>Nama Penerima</td>
						<td>
							<input type="text" name="nama_penerima"  pattern="(?! )[A-Za-z ]*" rows="5" placeholder="Nama Penerima" class="form-control col-xs-12" required"/>
					...
					<tr>
						...
						<td>
							<textarea name="alamat" id="" rows="5" placeholder="Alamat Lengkap" class="form-control col-xs-12" required>{{$dataUser->alamat}}</textarea>
						<span>
							<i><strong>
		...
		<input type="hidden" name="qty" value="{{$item_details['0']->qty}}">
		<input type="hidden" name="note" value="{{$item_details['0']->note}}">
		<input type="hidden" name="photo" value="{{$item_details['0']->photo}}">
		<input type="hidden" name="nama_foto" value="{{$item_details['0']->nama_foto}}">
		<input type="hidden" name="kodeDepan" value="{{$item_details['0']->kodeDepan}}">
		<input type="hidden" name="custom_id" value="{{$item_details['0']->custom_id}}">
